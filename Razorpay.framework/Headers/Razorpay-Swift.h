...
__attribute__((objc_runtime_name("_TtP8Razorpay31ExternalWalletSelectionProtocol_")))
...
__attribute__((objc_runtime_name("_TtC8Razorpay6Otpelf"))) __attribute__((objc_subclassing_restricted))
...
__attribute__((objc_runtime_name("_TtP8Razorpay21PluginPaymentDelegate_")))
...
__attribute__((objc_runtime_name("_TtC8Razorpay18PluginPaymentModel"))) __attribute__((objc_subclassing_restricted))
...
__attribute__((objc_runtime_name("_TtC8Razorpay8Razorpay"))) __attribute__((objc_subclassing_restricted))
...
__attribute__((objc_runtime_name("_TtP8Razorpay33RazorpayPaymentCompletionProtocol_")))
...
__attribute__((objc_runtime_name("_TtP8Razorpay41RazorpayPaymentCompletionProtocolWithData_")))
...
@protocol PluginPaymentDelegate __attribute__((visibility("default")));
- (BOOL)canProcessPaymentWithModel:(PluginPaymentModel * _Nonnull)model SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nonnull)identifier SWIFT_WARN_UNUSED_RESULT;
- (void)payWithModel:(PluginPaymentModel * _Nonnull)model;
@end
